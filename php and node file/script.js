...
app.post("/register/",(req,res,next) => {
    ...
    */
    ...
    connection.query("select * from varistable where name = ? ",[name], function(err,result, fields){
    ...
    if(result && result.length){
        ...
        var insert_cmd = " insert into varistable (name, gameTime, score) values (?,?,?)";
